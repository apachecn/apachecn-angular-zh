...
我们将使用 StackBlitz（[https://stackblitz.com/edit/angular-pzljm3](https://stackblitz.com/edit/angular-pzljm3) 来演示这些概念。SlackBlitz 是一个在线 IDE，用于运行 Angular 应用！
...
从教育的 Angular 来看，所有这些都很有趣。它没有描述房间里的大象，当事情变得复杂时，我们如何管理数据？我们必须处理的问题是：

*   双向数据流
*   缺乏可预测性（更改可能导致级联更改）
*   分散状态（没有唯一的真相来源，我们的组件可以位于部分更新的状态）

让我们在进入[第 5 章](05.html)时牢记这些担忧，*1.21 千兆瓦-Flux 模式解释*。**