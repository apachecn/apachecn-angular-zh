 ...
 **[第 5 章](05.html#1T1400-289fe2426d594f99a90e4363b2c9c34d)、*路由和延迟加载*允许用户在我们的应用程序中浏览需要设置路由的各种视图。Angular 提供了一个强大的路由，当与 NativeScript 结合使用时，它可以与 iOS 和 Android 上的本机移动页面导航系统协同工作。此外，我们将设置各种路由的延迟加载，以确保我们的应用程序的启动时间尽可能快。
