...
[第 3 章](03.html#ch03 "Chapter 3. Advanced Bootstrap Components and Customization")*高级引导组件和定制*介绍了如何使用 Jumbotron、Carousel 等组件，并通过输入组一路消费。
...
[第 5 章](05.html#page "Chapter 5. Routing")*路由*帮助您了解当用户执行应用程序任务时，路由器代码如何管理视图之间的导航。我们将了解如何创建静态路由以及包含参数的路由，以及如何配置它们。
...
[第 10 章](10.html#page "Chapter 10. Advanced Angular Techniques")*高级测角技术*介绍了高级测角技术。我们将在 Webpack 的帮助下改造我们的应用程序，并学习如何安装和使用 ng2 引导。我们将发现 Angular CLI 的世界，并将使用 AOT 大幅减少生产代码的大小。
...
无论您对 Bootstrap 或 Angular 了解多少，还是您是一个完全的初学者，本书都将增强您在这两个框架中的能力，并帮助您构建一个功能齐全的 web 应用程序。掌握 HTML、CSS 和 JavaScript 的工作知识，才能充分掌握引导和角度。
