...
你的应用程序将成功编译，但当你在浏览器中检查结果时，你将看不到任何天气数据。事实上，`CurrentWeather`组件似乎根本没有渲染，如下图所示：
...
有了优化的开发工具环境，您现在可以有效地进行故障排除，并解决早期出现的应用程序错误。
...
<figure class="mediaobject">![](../Images/B14094_A2_18.png)</figure>
