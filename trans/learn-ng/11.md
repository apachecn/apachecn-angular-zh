...
![Figure 11.1 – Karma test runner output](image/Figure_11.1_B15534.jpg)
...
![Figure 11.2 – Test failure](image/Figure_11.2_B15534.jpg)
...
![Figure 11.3 – Console test output](image/Figure_11.3_B15534.jpg)
...
Angular 应用程序具有一些执行路由的组件和其他路由到的组件，可能带有参数。在后一种情况下，组件的任务是挖掘参数的值，并相应地进行操作，例如调用服务。考虑以下组件：
