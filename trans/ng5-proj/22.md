...
![A458962_1_En_22_Fig1_HTML.gif](A458962_1_En_22_Fig1_HTML.gif)
...
集成测试发生在单元测试之后。它测试组合代码，模拟用户运行完整的应用程序。这是更高层次的测试——在不了解系统结构或实现的情况下测试系统的各个方面。集成测试确保应用程序按照用户的预期工作，并且应用程序的各个组成部分能够协同工作。
...
![A458962_1_En_22_Fig2_HTML.gif](A458962_1_En_22_Fig2_HTML.gif)
...
4.  Run tests: Use the following command:
    ...
    ![A458962_1_En_22_Fig3_HTML.jpg](A458962_1_En_22_Fig3_HTML.jpg)
...
![A458962_1_En_22_Fig4_HTML.jpg](A458962_1_En_22_Fig4_HTML.jpg)
