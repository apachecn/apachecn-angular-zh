...
4.  [T2`https://blog.angular.io/`](https://blog.angular.io/)
    ...
    确保你从 Angular 博客上获得了最新的更新。此外，注意有Angular的文档也很好，尤其是 PWA 指南。
...
9.  **网页组件**
    ...
    这是一项由Angular元件支撑的伟大技术。你可以在这里找到更多关于它的信息: [`https://angular.io/guide/elements`](https://angular.io/guide/elements) 。角藤 <sup>[1](#Fn1)</sup> (很快)之后，角元素会更好。别忘了留意它。
