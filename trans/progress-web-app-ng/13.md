...
现在我们需要创建“源服务工作器”我们开始吧。不过，首先要做的是:我们需要导入工具箱。
...
克隆 [`https://github.com/mhadaily/awesome-apress-pwa.git`](https://github.com/mhadaily/awesome-apress-pwa.git) ，进入 [12 章](12.html)，02-工具箱-设置文件夹，找到所有样本代码。您可以通过运行`npm run prod`在浏览器中构建应用并进行测试。
