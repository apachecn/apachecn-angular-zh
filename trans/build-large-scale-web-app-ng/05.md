...
![](Images/89837a9b-d48e-4a33-890c-c61bd5a326d6.png)
...
这告诉 Webpack，`app.js`是我们的应用程序的入口点，它应该在创建输出文件`bundle.js`时对所有依赖项进行爬网。默认情况下，Webpack 会将`bundle.js`放在`dist`目录中。
