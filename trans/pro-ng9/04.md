...
关于 Bootstrap，我不想讲太多细节，因为这不是本书的主题，但是我想给你足够的信息，这样你就可以知道例子的哪些部分是Angular特征，哪些部分是 Bootstrap 样式。参见 [`http://getbootstrap.com`](http://getbootstrap.com) 了解 Bootstrap 提供的特性的全部细节。
