...
[第 3 章](3.html "Chapter 3. TypeScript Crash Course")*TypeScript速成课*解释说，尽管 Angular 是语言不可知论者，但谷歌的建议是利用TypeScript的静态TypeScript。在本章中，您将学习在 TypeScript 中开发Angular应用程序所需的所有基本语法。
...
[第 8 章](8.html "Chapter 8. Tooling and Development Experience")*工具和开发经验*探讨了Angular应用程序开发中的一些高级主题，如提前编译、在 Web Worker 中运行应用程序以及服务器端渲染。在本章的第二部分中，我们将探讨可以简化开发人员日常生活的工具，如 angular cli、angular seed 等。
