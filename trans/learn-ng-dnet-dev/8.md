...
我们只看到了 Jasmine 框架的基础知识，还有更多可用的功能。您可以通过访问官方网站[了解它们 http://jasmine.github.io/](http://jasmine.github.io/) 。这篇介绍足以让我们学习测试Angular服务和组件。
...
我们刚刚了解了如何在 Angular 应用中测试服务。现在，让我们来讨论测试Angular分量。执行以下步骤为应用创建`AppComponent`：
