...
Angular 最令人惊奇的一点是，它是一个完整的生态系统（一个框架），而不是一个库。在这个生态系统中，角度路由是学习和理解的最关键的模块之一。在本章中，您将学习一些非常酷的技术，这些技术涉及到角度导航中的路由和导航。您将了解如何保护路由、侦听路由更改以及配置路由更改的全局操作。
...
*   角度路由文件（[https://angular.io/guide/router](https://angular.io/guide/router)
