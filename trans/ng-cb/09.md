...
![Figure 9.1 – The using-cdk-virtual-scroll app running on http://localhost:4200 ](image/Figure_9.1_B15150.jpg)
...
![Figure 9.2 – App stuck with a blank screen while rendering list items ](image/Figure_9.2_B15150.jpg)
...
![Figure 9.3 – Each list item has a height of approximately 110 pixels ](image/Figure_9.3_B15150.jpg)
...
![Figure 9.4 – Showing only a few <div> elements rendered on DOM due to virtual scroll ](image/Figure_9.4_B15150.jpg)
...
![Figure 9.5 – The using-list-key-manager app running on http://localhost:4200 ](image/Figure_9.5_B15150.jpg)
...
![Figure 9.6 – The pointy-little-popovers app running on http://localhost:4200 ](image/Figure_9.6_B15150.jpg)
...
9.  If you refresh the app now and click on any of the list items, you should see a drop-down menu being shown, as follows:
    ...
    ![Figure 9.7 – Working drop-down menu for each list item ](image/Figure_9.7_B15150.jpg)
...
10.  We now have to implement the part where we show a pointy little arrow with the drop-down menu so that we can correlate the drop-down menu with the list item. First, add the following styles to the `.popover-menu` class in the `src/styles.scss` file:
    ...
    ![Figure 9.8 – Drop-down arrow pointing at the wrong list item ](image/Figure_9.8_B15150.jpg)
...
![Figure 9.9 – Drop-down arrow pointing at the correct list item (pointing downward) ](image/Figure_9.9_B15150.jpg)
...
![Figure 9.10 – using-cdk-clipboard-api running on http://localhost:4200 ](image/Figure_9.10_B15150.jpg)
...
![Figure 9.11 – The using-cdk-drag-drop app running on http://localhost:4200 ](image/Figure_9.11_B15150.jpg)
...
6.  Finally, we need to implement the `onFileDrop` method. Update the `folders-list.component.ts` file, as follows:
    ...
    ![Figure 9.12 – Dragging and dropping a file to another folder ](image/Figure_9.12_B15150.jpg)
...
![Figure 9.13 – The using-cdk-stepper app running on http://localhost:4200 ](image/Figure_9.13_B15150.jpg)
...
12.  Now, we'll add a label for each step to show our main content for the selected step—this is pretty simple to do. We need to add an `<ng-template>` element within each `<cdk-step>` element. Update the `game.component.html` file, as follows:
    ...
    ![Figure 9.14 – The first step and the navigation button using CDKStepper ](image/Figure_9.14_B15150.jpg)
...
![Figure 9.15 – Displaying results in the leaderboard at Step 3 ](image/Figure_9.15_B15150.jpg)
...
![Figure 9.16 – The resizable-text-inputs-using-cdk app running on http://localhost:4200 ](image/Figure_9.16_B15150.jpg)
...
4.  Now, we'll apply the `cdkTextareaAutosize` directive to our `<text-area>` element so that it can be resized automatically based on the content. Update the `write-message.component.html` file, as follows:
    ...
    ![Figure 9.17 – text-area being resized based on the content ](image/Figure_9.17_B15150.jpg)
...
![Figure 9.18 – <text-area> size being reset on new message creation ](image/Figure_9.18_B15150.jpg)
